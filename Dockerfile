...
LABEL maintainer "apisuserbot <nafisqurtubi154@gmail.com>"
...
ADD https://raw.githubusercontent.com/apisuserbot/King-Userbot/King-Userbot/requirements.txt requirements.txt
# LynxUserbot Instalitation
RUN set -ex \
